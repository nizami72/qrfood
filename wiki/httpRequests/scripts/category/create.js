...
const image = ["chicken.webp", "beef.webp", "soup.webp", "rice.webp", "salad.webp", "pasta.webp", "snack.webp", "mixed.webp", "chicken.webp", "fish.webp", "vegetarian.webp", "rice.webp", "soup.webp", "bakery.webp", "wrap.webp"];
...
request.variables.set("imagePath", `./image/${image[x]}`);
request.variables.set("fileName", `${image[x]}`);
