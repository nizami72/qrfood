...
Вот таблица кодов для системы QR Food:Код (Decimal)Бит (Binary)Категория подпискиОписание100001PRODUCT_UPDATESНовости платформы и обновления фич200010WEEKLY_DIGESTЕженедельная аналитика ресторана400100SUCCESS_TIPSСоветы по увеличению продаж801000PROMOTIONSМаркетинговые акции (B2C)1610000ONBOARDING_NUDGEНапоминание о незаполненном профиле

Вот таблица кодов для системы QR Food:


| Код (Decimal)  | Бит (Binary)       | Категория подписки | Описание                            |
|----------------|--------------------|--------------------|-------------------------------------|
| 1              | 00001              | PRODUCT_UPDATES    | Новости платформы и обновления фич  | 
| 2              | 00010              | WEEKLY_DIGEST      | Еженедельная аналитика ресторана    |
| 4              | 00100              | SUCCESS_TIPS       | Советы по увеличению продаж         |
| 8              | 01000              | PROMOTIONS         | Маркетинговые акции (B2C)           |
| 16             | 10000              | ONBOARDING_NUDGE   | Напоминание о незаполненном профиле |